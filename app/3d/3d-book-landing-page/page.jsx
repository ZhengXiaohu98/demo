...
import { Environment, OrbitControls, Text, Float, Image as IMG, SpotLight } from '@react-three/drei';
    ...
    <div className='overflow-x-hidden'>
      <div className='fixed top-0 left-0 h-screen w-screen bg-radial-gradient select-none'>
        ...
        <div className='absolute z-50 sm:bottom-4 md:bottom-10 lg:bottom-20 w-full flex flex-row justify-center items-center flex-wrap sm:gap-x-2 md:gap-x-4 sm:gap-y-1 md:gap-y-3 lg:px-20 md:px-10 sm:px-4'>
          ...
          <div
            className={`hover:cursor-pointer transition md:px-4 md:py-2 sm:px-2 sm:py-1 md:text-base sm:text-sm rounded-lg ${activePage == pages.length ? 'bg-blue-400/80 text-blue-50' : 'hover:bg-indigo-900/10 bg-indigo-900/60  text-indigo-100 hover:border hover:border-white hover:border-dashed hover:-translate-y-1'} `}
            onClick={() => {
              window.scrollTo({
